...
from _old.config import CHAT_GLM_MODEL_PATH, CHAT_GLM_SERVER_PORT, CHAT_GLM_SERVER_HOST
...
if __name__ == "__main__":
    ...
    model = AutoModel.from_pretrained(CHAT_GLM_MODEL_PATH, trust_remote_code=True).quantize(4).cuda()
    ...
    uvicorn.run(app, host=CHAT_GLM_SERVER_HOST, port=CHAT_GLM_SERVER_PORT, workers=1)
